...
public class EzflowApp {

    private static final Logger log = LoggerFactory.getLogger(EzflowApp.class);

    private final Environment env;

    public EzflowApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(EzflowApp.class);
